    ...
    <div className="overflow-hidden rounded-xl border bg-card shadow-sm">
      ...
      <div className="space-y-3 px-5 py-4">
        <textarea
          ...
          rows={4}
          placeholder={"475563\n475573\n476117\n…"}
          className="w-full rounded-md border px-3 py-2 font-mono text-xs outline-none focus:border-emerald-400"
        />
        <div className="flex flex-wrap items-center gap-2">
          ...
          <label className="inline-flex items-center gap-1.5 text-[11px] font-medium text-muted-foreground" title="Already-sourced leads pe bhi push kare (FB ad / update fields add karne ke liye). Source overwrite ho sakta hai.">
            <input type="checkbox" checked={force} onChange={(e) => setForce(e.target.checked)} className="h-3.5 w-3.5 rounded border-input accent-emerald-600" />
